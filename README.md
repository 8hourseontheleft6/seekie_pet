...
一个轻量级的桌面宠物应用，显示一个机器人在菜单栏区域移动，支持快捷键功能。
...
- **多线程**: Python threading 模块，用于同时处理动画、系统托盘和快捷键
...
- `HOTKEY_SCREENSHOT`: 截图快捷键（默认Ctrl+J）
