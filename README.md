...
### v3.4.0 (2026-04-18) - 独立窗口版设置窗口
- **独立窗口版**: 添加独立窗口版设置窗口，不打开浏览器
- **tkinterweb集成**: 使用tkinterweb在tkinter窗口中显示HTML内容
- **现代化界面**: 保留现代化深色主题界面和所有功能
- **独立运行**: 设置窗口作为独立应用程序窗口运行
- **智能回退**: 独立窗口失败时自动回退到浏览器版Web设置窗口
- **路径智能查找**: 自动查找HTML模板文件位置

### v3.3.0 (2026-04-18) - Web设置窗口版
- **Web设置窗口**: 添加基于Flask的现代化Web设置窗口，类似洛雪音乐桌面客户端风格
- **现代化界面**: 使用HTML/CSS/JavaScript创建现代化深色主题界面
- **多页面设计**: 支持常规设置、快捷键设置、关于页面切换
- **实时预览**: 滑块调整时实时显示数值变化
- **响应式设计**: 支持桌面和移动端自适应布局
